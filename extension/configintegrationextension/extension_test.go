...
func TestFindIntegration(t *testing.T) {
	...
	config := configFromFile(t, "testdata/config-with-templates.yaml")
	extension := newConfigTemplateExtension(&config)
...
func configFromFile(t *testing.T, path string) Config {
