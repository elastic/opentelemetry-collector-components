...
require (
	...
	github.com/elastic/opentelemetry-collector-components/exporter/prometheusremotewriteexporter v0.0.0-00010101000000-000000000000
...
replace (
	github.com/elastic/opentelemetry-collector-components/exporter/prometheusremotewriteexporter => ../../../exporter/prometheusremotewriteexporter
