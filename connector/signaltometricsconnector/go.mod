module github.com/elastic/opentelemetry-collector-components/connector/signaltometricsconnector
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/sampling v0.112.0
