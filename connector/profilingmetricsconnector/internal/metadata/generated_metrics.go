...
// AttributeKernelArea specifies the value kernel_area attribute.
type AttributeKernelArea int

const (
	_ AttributeKernelArea = iota
	AttributeKernelAreaNetwork
	AttributeKernelAreaIpc
	AttributeKernelAreaDisk
	AttributeKernelAreaMemory
	AttributeKernelAreaSynchronization
)

// String returns the string representation of the AttributeKernelArea.
func (av AttributeKernelArea) String() string {
	switch av {
	case AttributeKernelAreaNetwork:
		return "network"
	case AttributeKernelAreaIpc:
		return "ipc"
	case AttributeKernelAreaDisk:
		return "disk"
	case AttributeKernelAreaMemory:
		return "memory"
	case AttributeKernelAreaSynchronization:
		return "synchronization"
	}
	return ""
}

// MapAttributeKernelArea is a helper map of string to AttributeKernelArea attribute value.
var MapAttributeKernelArea = map[string]AttributeKernelArea{
	"network":         AttributeKernelAreaNetwork,
	"ipc":             AttributeKernelAreaIpc,
	"disk":            AttributeKernelAreaDisk,
	"memory":          AttributeKernelAreaMemory,
	"synchronization": AttributeKernelAreaSynchronization,
}

// AttributeKernelIo specifies the value kernel_io attribute.
type AttributeKernelIo int

const (
	_ AttributeKernelIo = iota
	AttributeKernelIoRead
	AttributeKernelIoWrite
)

// String returns the string representation of the AttributeKernelIo.
func (av AttributeKernelIo) String() string {
	switch av {
	case AttributeKernelIoRead:
		return "read"
	case AttributeKernelIoWrite:
		return "write"
	}
	return ""
}

// MapAttributeKernelIo is a helper map of string to AttributeKernelIo attribute value.
var MapAttributeKernelIo = map[string]AttributeKernelIo{
	"read":  AttributeKernelIoRead,
	"write": AttributeKernelIoWrite,
}

// AttributeKernelProto specifies the value kernel_proto attribute.
type AttributeKernelProto int

const (
	_ AttributeKernelProto = iota
	AttributeKernelProtoTcp
	AttributeKernelProtoUdp
	AttributeKernelProtoOther
)

// String returns the string representation of the AttributeKernelProto.
func (av AttributeKernelProto) String() string {
	switch av {
	case AttributeKernelProtoTcp:
		return "tcp"
	case AttributeKernelProtoUdp:
		return "udp"
	case AttributeKernelProtoOther:
		return "other"
	}
	return ""
}

// MapAttributeKernelProto is a helper map of string to AttributeKernelProto attribute value.
var MapAttributeKernelProto = map[string]AttributeKernelProto{
	"tcp":   AttributeKernelProtoTcp,
	"udp":   AttributeKernelProtoUdp,
	"other": AttributeKernelProtoOther,
}
