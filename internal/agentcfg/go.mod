module github.com/elastic/opentelemetry-collector-components/internal/agentcfg

go 1.23.4

replace github.com/elastic/opentelemetry-collector-components/internal/elasticsearch => ../elasticsearch/
