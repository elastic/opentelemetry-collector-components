...
//
// Copied from github.com/elastic/apm-data/input/elasticapm/internal/modeldecoder/v2.
// Differences from the original:
//   - package name changed from v2 to ndjsondecoder
//   - type context renamed to eventContext to avoid collision with the stdlib
//     "context" package imported elsewhere in this package
...
func (val *eventContext) IsSet() bool {
...
func (val *eventContext) validate() error {
...
func (val *eventContext) processNestedSource() error {
	if err := val.Service.processNestedSource(); err != nil {
		return fmt.Errorf("service: %w", err)
	}
	if err := val.Cloud.processNestedSource(); err != nil {
