module github.com/elastic/opentelemetry-collector-components/processor/rawretriever
...
replace github.com/elastic/opentelemetry-collector-components/extension/rawsamplingbuffer => ../../extension/rawsamplingbuffer
