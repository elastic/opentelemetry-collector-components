...
func TestConvertComponentConfig(t *testing.T) {
	type componentConfig struct {
		SomeSetting  string `mapstructure:"some_setting"`
		OtherSetting string `mapstructure:"other_setting"`
	}

	create := func() component.Config {
	...
	converted, err := convertComponentConfig(create, config)
	require.NoError(t, err)
	assert.EqualValues(t, expected, converted)
}
