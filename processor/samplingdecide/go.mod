module github.com/elastic/opentelemetry-collector-components/processor/samplingdecide
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/ottl/ottllog v0.138.0
